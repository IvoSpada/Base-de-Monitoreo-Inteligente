...
function calculatePublicTransportEmissions() {
  ...
  let totalEmissions =
    convertedValues.autobus * factors.autobus +
    convertedValues.autocar * factors.autocar +
    convertedValues.nacTren * factors.nacTren +
    convertedValues.interTren * factors.interTren +
    convertedValues.tranvia * factors.tranvia +
    convertedValues.metro * factors.metro +
    convertedValues.taxi * factors.taxi;
  ...
  resultElement.textContent = `Huella Total de Transporte Público = ${totlaEmissionsBondi.toFixed(
    2
  )} toneladas de CO2`;
